...
namespace NapoleonicWars.Core.TerrainGeneration
{
    ...
    {
        public static System.Collections.Generic.List<Vector2> GeneratePoints(float radius, Vector2 sampleRegionSize, int numSamplesBeforeRejection = 30, int seed = 0)
        {
            ...
            while (spawnPoints.Count > 0)
            {
                ...
                for (int i = 0; i < numSamplesBeforeRejection; i++)
                {
                    ...
                    float r = radius + (float)prng.NextDouble() * radius; // Entre R et 2R
        ...
        static bool IsValid(Vector2 candidate, Vector2 sampleRegionSize, float cellSize, float radius, System.Collections.Generic.List<Vector2> points, int[,] grid)
        {
